...
glm::vec3 my_material_ambient = { 0.1, 0.1, 0.1 }, my_material_diffuse = { 0.5, 0.2, 0.5 }, my_material_specular = { 0.88, 0.08, 0.8 }; GLfloat my_material_shininess = 100.0f;
...
void init_mesh() {
	...
	Object obj4 = {};
	obj4.mesh = sphereS;
	obj4.material = MaterialType::MY_MATERIAL; // NO_MATERIAL;
...
void modifyModelMatrix(glm::vec3 translation_vector, glm::vec3 rotation_vector, GLfloat angle, GLfloat scale_factor)
{
	switch (TransformMode) {
		case OCS:{
			//rotation_vector specifica gli assi coinvolti nella trasformazione, puo' essere quindi usato nella formula sottostante per ottenere il vettore di scaling corretto
